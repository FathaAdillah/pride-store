                            ...
                            <div class="card-body">
                                <form action="{{ route('pengeluaran.update', $pengeluaran) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="keterangan" id="keterangan" required>{{ $pengeluaran->keterangan }}
                                        </textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="qty">Qty</label>
                                        <input type="number" value="{{ $pengeluaran->jumlah }}" class="form-control" name="qty" id="qty" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="nominal">Nominal</label>
                                        <input type="number" class="form-control" name="nominal" id="nominal"
                                            placeholder="Rp." value="{{ $pengeluaran->nominal }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggal">Tanggal</label>
                                        <input type="date" class="form-control datepicker" value="{{ $pengeluaran->tanggal }}" name="tanggal" id="tanggal"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectric" name="produk_id" id="produk_id" required>
                                            ...
                                            @foreach ($produks as $item)
                                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                                            @endforeach
                                            <button href="{{ route('pengeluaran.index') }}"
